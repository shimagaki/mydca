...
def data_model():
    ...
    fname_model =  "Correlation_CD_L"+str(L)+"_hidden_c++.dat"
    
    #fname_data = "Xi_model_estimator_CD_L"+str(L)+"_Hidden.dat"
...
def visualize_estimator():
    ...
    x = np.linspace(0.0,0.05,n_parameter)
    y = np.linspace(0.0,0.05,n_parameter)
    plt.plot(x,y)
