...
int T_interval = 1e2;
int N_sample = 1e5;
int M = 1e3 ; // number of sample of average by statistical model. 
...
void output_model_empirical(){
	/****** Coupling Constant *****/
	string fname_fij = "fij_L"+to_string(L)+"_c++.dat";
	string fname_pij = "pij_L"+to_string(L)+"_c++.dat";
	...
	/****** Coupling Constant *****/
	string fname_fi = "fi"+to_string(L)+"_c++.dat";
	string fname_pi = "pi"+to_string(L)+"_c++.dat";
