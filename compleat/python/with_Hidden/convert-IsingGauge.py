...
def outputestimator(h_data,h,J_data,J):
    ...
    fname_model = "J_model_estimator_CD_L"+str(L)+"_IsingGauge.dat"
    ...
    fname_model_h = "h_model_estimator_CD_L"+str(L)+"_IsingGauge.dat"
...
if __name__ == "__main__":
    ...
    fJname_model = "J_model_estimator_CD_L"+str(L)+".dat"
    
    fhname_data = "h_data_L"+str(L)+".dat"
    #fhname_model = "h_model_estimator_L"+str(L)+".dat"
    fhname_model = "h_model_estimator_CD_L"+str(L)+".dat"
