...
def outputestimator(J_data,J):
    ...
    fname = "J_model_estimator_L"+str(L)+"_IsingGauge_c++.dat"
    ...
    fname = "h_model_estimator_L"+str(L)+"_IsingGauge_c++.dat"
...
if __name__ == "__main__":
    ...
    #print "h_IG(h_data)= ", h_IG 
    
    print "\n"
    J_IG = Ising_Gauge_J(J_model)
    #h_IG = Ising_Gauge_h(h_model,J_model)
    print "J_IG(J_model)= ", J_IG 
    #print "h_IG(h_model)= ", h_IG 
